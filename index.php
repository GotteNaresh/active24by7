        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <p class="description">We are collect client requirements then we should develop Web Applications.</p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
            <div class="box featured">
              ...
              <h4><sup>Rs</sup>10000<span> / Month (3 Months duration)</span></h4>
              <ul>
                <li>Aida dere</li>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              ...
              <ul>
                ...
                <li class="na">1 Project</li>
                <li class="na">Real-Time Project Work(for Basic Experience)</li>
              </ul>
              <div class="btn-wrap">
                <a href="#" class="btn-buy">Buy Now</a>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              <span class="advanced">Advanced</span>
              <h3>JavaScript</h3>
              <h4><sup>Rs</sup>10000<span> / month ( 1 Month duration)</span></h4>
              <ul>
                <li>Basic Concepts</li>
                <li>Advanced concepts</li>
                <li class="na">1 Project</li>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              <span class="advanced">Advanced</span>
              <h3>Jquery</h3>
              <h4><sup>Rs</sup>2000<span> / month ( 1 Month duration)</span></h4>
              <ul>
                <li>Basic Concepts</li>
                <li>Advanced concepts</li>
                <li class="na">1 Project</li>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              ...
              <h4><sup>Rs</sup>5000<span> / month ( 1 Month duration)</span></h4>
              <ul>
                <li>Basic Concepts</li>
                <li>Advanced concepts</li>
                <li class="na">1 Project</li>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              <span class="advanced">Advanced</span>
              <h3>SASS</h3>
              <h4><sup>Rs</sup>3000<span> / month ( 1 Month duration)</span></h4>
              <ul>
                <li>Basic Concepts</li>
                <li>Advanced concepts</li>
                <li class="na">1 Project</li>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              ...
              <h4><sup>Rs</sup>4000<span> / month ( 1 Month duration)</span></h4>
              <ul>
                <li>Basic Concepts</li>
                <li>Advanced concepts</li>
                <li class="na">1 Project</li>
