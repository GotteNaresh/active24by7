  ...
  <body class="page-body" data-url="https://demo.neontheme.com">
    <div class="page-container">
      ...
      ?>
        ...
        <br /> -->
        <div class="row">
          <a class="col-sm-3 mycourse" data='mern' href="<?php echo $base_url?>/course-details/?id=mern">
            <div class="tile-title tile-purple" data='mern'>
              <div class="icon" data='mern'>
                <img src="../assets/images/courses/mern_img.jpg" alt=""  class="course-img" />
              </div>
              <div class="title" data='mern'>
                <h3 data='mern' >MERN Full Stack Development</h3>
                <p data='mern'>Price : 29999/-</p>
                <p data='mern' >Validity : 20 Dec 2023(1 Year Only)</p>
              </div>
            </div>
          </a>
          <div class="col-sm-3 mycourse" data='mean' >
