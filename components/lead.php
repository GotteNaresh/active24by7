        ...
        <div class="row mt-1 d-flex justify-content-end" data-aos="fade-right" data-aos-delay="100">
          <div class="col-lg-12 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="100">
            ...
            <form  method="post" role="form" class="lead-us-form php-email-form" name="lead-us-form" >
              ...
              <div class="form-group mt-3">
                <label for="course">Select your course from the list:</label>
                <input class="form-control" list="courses" name="course" id="course" placeholder="Please Select Your Course" required >
                <datalist id="courses">
